...
folder_path = "/userdirs/piyumal/sihala_data/sst_data"
sst_dev_data_path = folder_path + "/dev.tsv"
sst_train_data_path = folder_path + "/train.tsv"
sst_test_data_path = folder_path + "/test.tsv"
...
history = model.fit(x=padded_docs_train, y=labels_train, validation_data=(padded_docs_test, labels_test), epochs=20_000)
